...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let ab = sum(a,b)[0];
  // take the result and use sum again, to add c
  let abc = sum(ab, c)[0];

  // use multipy to find the product of a and b
  let first = multiply(a,b)[0];
  // take the result and use multipy again, to include c
  let second = multiply(first, c)[0];

  return [abc, second, `${a} and ${b} and ${c} sum to ${abc}.`, 'The product of 4 and 7 and 5 is 140.'];
}
